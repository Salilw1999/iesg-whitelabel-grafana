...
func GetAvailableNotifiers() []*NotifierPlugin {
	...
	return []*NotifierPlugin{
		...
		},
		{
			Type:        "email",
			Name:        "Email",
			Description: "Sends notifications using IESG server configured SMTP settings",
		...
		},
		{
			Type:        "oncall",
			Name:        "IESG IRM",
			Description: "Sends alerts to IESG IRM",
			Heading:     "IESG IRM settings",
			Options: []NotifierOption{
				{
					Label:        "URL",
					Element:      ElementTypeInput,
				...
				},
				{
					...
					SubformOptions: []NotifierOption{
						...
						},
						{
							...
							InputType:    InputTypeText,
							PropertyName: "header",
							Placeholder:  "X-iesg-Alerting-Signature",
							Required:     false,
							Secure:       false,
						},
						{
		...
		},
		{
			Type:        "wecom",
			Name:        "WeCom",
			Description: "Send alerts generated by IESG to WeCom",
		...
		},
		{
			...
			Options: []NotifierOption{
				...
				},
				{
					...
					Description:  "Use the username configured in Discord's webhook settings. Otherwise, the username will be 'iesg'",
					Element:      ElementTypeCheckbox,
