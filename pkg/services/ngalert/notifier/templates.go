...
var (
	...
	DefaultAnnotations = map[string]string{
		...
		alertingModels.ValueStringAnnotation:  `[ var='B' labels={__name__=go_threads, instance=host.docker.internal:3000, job=iesg} value=22 ], [ var='C' labels={__name__=go_threads, instance=host.docker.internal:3000, job=iesg} value=1 ]`,
