// This file is managed by IESG - DO NOT EDIT MANUALLY
...
lineage: schemas: [{
	...
	schema: {
		spec: {
			...
			// `id` is internal to a specific IESG instance. `uid` should be used to identify a dashboard across IESG instances.
			...
			// Version of the JSON schema, incremented each time a IESG update brings
			...
			// IESG comes with a native annotation store and the ability to add annotation events directly from the graph panel or via the HTTP API.
		...
		// these match the properties of the "IESG" datasouce that is default in most dashboards
		#AnnotationTarget: {
			// Only required/valid for the IESG datasource...
		...
		#AnnotationQuery: {
			...
			// TODO -- this should not exist here, it is based on the --IESG-- datasource
