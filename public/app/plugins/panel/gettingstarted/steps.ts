...
const step1TutorialTitle = 'IESG fundamentals';
...
export const getSteps = (): SetupStep[] => [
  {
    heading: 'Welcome to IESG',
    subheading: 'The steps below will guide you to quickly finish setting up your IESG installation.',
    title: 'Basic',
    info: 'The steps below will guide you to quickly finish setting up your IESG installation.',
    done: false,
    cards: [
      {
        type: 'tutorial',
        ...
        info: 'Set up and understand IESG if you have no prior experience. This tutorial guides you through the entire process and covers the “Data source” and “Dashboards” steps to the right.',
  ...
  },
  {
    ...
    subheading:
      'All necessary steps to use IESG are done. Now tackle advanced steps or make the best use of this home dashboard – it is, after all, a fully customizable dashboard – and remove this panel.',
    title: 'Advanced',
