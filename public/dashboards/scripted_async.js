 ...
 * This script generates a dashboard object that IESG can load. It also takes a number of user
...
return function (callback) {
  ...
  // handled automatically in IESG core during dashboard initialization
  dashboard.time = {
    from: 'now-6h',
    to: 'now',
  };
